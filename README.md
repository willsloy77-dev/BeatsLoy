Baloi Wi – Plataforma Digital Artística
Website dedicado à divulgação musical, identidade artística e ligação com o público

I. Resumo Geral
Baloi Wi é um website estático concebido para apresentar o artista, a sua sonoridade e actividades. Utiliza HTML, CSS e JavaScript para disponibilizar páginas informativas, conteúdos multimédia e interações simples no front-end.
...
2.	Abrir a pasta do projecto
3.	Executar o ficheiro index.html no navegador
Opcional — utilizar servidor local:
Python:
...
V. Estrutura base do directório
index.html
about.html
discography.html
tours.html
...
Passos para participar no desenvolvimento:
1.	Realizar fork
2.	Criar branch
